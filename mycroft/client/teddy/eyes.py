...
class TeddyEyes:
    """
    Listens to teddy commands for Mycroft's Eyes.
    ...
    def __init_events(self):
        self.ws.on('teddy.eyes.on', self.on)
        self.ws.on('teddy.eyes.off', self.off)
        self.ws.on('teddy.eyes.blink', self.blink)
        self.ws.on('teddy.eyes.narrow', self.narrow)
        self.ws.on('teddy.eyes.look', self.look)
        self.ws.on('teddy.eyes.color', self.color)
        self.ws.on('teddy.eyes.level', self.brightness)
        self.ws.on('teddy.eyes.volume', self.volume)
        self.ws.on('teddy.eyes.spin', self.spin)
        self.ws.on('teddy.eyes.timedspin', self.timed_spin)
        self.ws.on('teddy.eyes.reset', self.reset)
