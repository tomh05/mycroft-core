...
class TeddyMouth:
    """
    Listens to teddy commands for Mycroft's Mouth.
    ...
    def __init_events(self):
        self.ws.on('teddy.mouth.reset', self.reset)
        self.ws.on('teddy.mouth.talk', self.talk)
        self.ws.on('teddy.mouth.think', self.think)
        self.ws.on('teddy.mouth.listen', self.listen)
        self.ws.on('teddy.mouth.smile', self.smile)
        self.ws.on('teddy.mouth.viseme', self.viseme)
        self.ws.on('teddy.mouth.text', self.text)
